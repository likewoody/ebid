...
public class MyPurchase extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					MyPurchase frame = new MyPurchase();
	...
	private JLabel getLblImage() {
		if (lblImage == null) {
			lblImage = new JLabel("");
			lblImage.setIcon(new ImageIcon(MyPurchase.class.getResource("/com/javalec/images/MyPurchase.png")));
